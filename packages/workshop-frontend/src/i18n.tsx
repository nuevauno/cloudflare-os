...
const messages = {
  es: {
    ...
    'common.loading': 'Cargando…', 'nav.blueprints': 'Plantillas', 'nav.outputs': 'Resultados', 'nav.sales': 'Ventas', 'nav.collections': 'Cobranza', 'nav.certificates': 'Certificados', 'nav.dispatch': 'Guías', 'nav.fiscal': 'Documentos fiscales', 'nav.vault': 'Bóveda', 'nav.explore': 'Explorar',
  ...
  en: {
    ...
    'common.loading': 'Loading…', 'nav.blueprints': 'Templates', 'nav.outputs': 'Outputs', 'nav.sales': 'Sales', 'nav.collections': 'Collections', 'nav.certificates': 'Certificates', 'nav.dispatch': 'Dispatch', 'nav.fiscal': 'Fiscal documents', 'nav.vault': 'Vault', 'nav.explore': 'Explore',
