...
const messages = {
  es: {
    ...
    'common.loading': 'Cargando…', 'nav.blueprints': 'Plantillas', 'nav.outputs': 'Resultados', 'nav.sales': 'Ventas', 'nav.collections': 'Cobranza', 'nav.certificates': 'Certificados', 'nav.explore': 'Explorar',
  ...
  en: {
    ...
    'common.loading': 'Loading…', 'nav.blueprints': 'Templates', 'nav.outputs': 'Outputs', 'nav.sales': 'Sales', 'nav.collections': 'Collections', 'nav.certificates': 'Certificates', 'nav.explore': 'Explore',
