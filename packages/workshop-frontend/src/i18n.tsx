...
const messages = {
  es: {
    ...
    'sales.balance': 'Saldo', 'sales.paid': 'Pagado', 'sales.empty': 'Aún no hay documentos comerciales.',
  ...
  en: {
    ...
    'sales.balance': 'Balance', 'sales.paid': 'Paid', 'sales.empty': 'There are no commercial documents yet.',
