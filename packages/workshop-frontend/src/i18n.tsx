...
const messages = {
  es: {
    ...
    'nav.blueprints': 'Plantillas', 'nav.outputs': 'Resultados', 'nav.sales': 'Ventas', 'nav.explore': 'Explorar',
  ...
  en: {
    ...
    'nav.blueprints': 'Templates', 'nav.outputs': 'Outputs', 'nav.sales': 'Sales', 'nav.explore': 'Explore',
