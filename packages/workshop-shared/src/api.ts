...
export interface AuthenticatedApi extends RpcTarget {
  ...
  posOpenSession(organizationId:string,companyId:string,openingCashMinor:number,openingNote?:string):Promise<PosLoadDataView['session']>;
  ...
  posCloseSession(organizationId:string,companyId:string,sessionId:string,countedCashMinor:number,closingNote?:string):Promise<{expectedCashMinor:number;countedCashMinor:number;differenceMinor:number}>;
