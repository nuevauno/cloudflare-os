...
export interface PosOrderMetadataView {partnerId?:string;pricelistId?:string;fiscalPositionId?:string;shippingDate?:string;orderName?:string;generalNote?:string;internalNote?:string;guestCount:number;tipMinor:number;takeaway:boolean;invoiceRequested:boolean;preparationState:'draft'|'sent'|'preparing'|'ready'|'served'}
